...
.field public cookieHeaders:Ljava/util/List;
...
.field public gzipUsage:Lorg/nanohttpd/protocols/http/response/Response$GzipUsage;
...
.field public final lowerCaseHeader:Ljava/util/Map;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/Map<",
            "Ljava/lang/String;",
...
.field public requestMethod:Lorg/nanohttpd/protocols/http/request/Method;

.field public status:Lorg/nanohttpd/protocols/http/response/IStatus;
...
.method public constructor <init>(Lorg/nanohttpd/protocols/http/response/IStatus;Ljava/lang/String;Ljava/io/InputStream;J)V
    ...
    .line 12
    iput-boolean p2, p0, Lorg/nanohttpd/protocols/http/response/Response;->keepAlive:Z
...
.method public static synthetic access$000(Lorg/nanohttpd/protocols/http/response/Response;)Ljava/util/Map;
    .registers 1
...
.method public send(Ljava/io/OutputStream;)V
    ...
    .line 258
    .line 259
    invoke-virtual {p0, p1, v2, v3}, Lorg/nanohttpd/protocols/http/response/Response;->sendBodyWithCorrectTransferAndEncoding(Ljava/io/OutputStream;J)V
    ...
    throw p1
    :try_end_116
    .catch Ljava/io/IOException; {:try_start_12 .. :try_end_116} :catch_116
...
.method public final sendBody(Ljava/io/OutputStream;J)V
    .registers 12
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
...
.method public final sendBodyWithCorrectEncoding(Ljava/io/OutputStream;J)V
    .registers 6
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    .line 25
    .line 26
    invoke-virtual {p0, p2, v0, v1}, Lorg/nanohttpd/protocols/http/response/Response;->sendBody(Ljava/io/OutputStream;J)V
    ...
    .line 33
    :cond_20
    invoke-virtual {p0, p1, p2, p3}, Lorg/nanohttpd/protocols/http/response/Response;->sendBody(Ljava/io/OutputStream;J)V
...
.method public final sendBodyWithCorrectTransferAndEncoding(Ljava/io/OutputStream;J)V
    .registers 6
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    .line 17
    .line 18
    invoke-virtual {p0, p2, v0, v1}, Lorg/nanohttpd/protocols/http/response/Response;->sendBodyWithCorrectEncoding(Ljava/io/OutputStream;J)V
    ...
    .line 35
    :cond_22
    invoke-virtual {p0, p1, p2, p3}, Lorg/nanohttpd/protocols/http/response/Response;->sendBodyWithCorrectEncoding(Ljava/io/OutputStream;J)V
